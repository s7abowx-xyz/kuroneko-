...
- **تسجيل دخول حقيقي عبر GitHub وGoogle** (OAuth رسمي، مو محاكاة)
- **بوابة حماية من البوتات** في `/verify` (proof-of-work، شبيهة بشاشة Cloudflare)
...
- `/account` لعرض بيانات حسابك (يتطلب تسجيل دخول)
...
### تفعيل بوابة الحماية من البوتات
```
ENABLE_BOT_CHECK="true"
```
بهذا كل صفحات الموقع (عدا الـ API نفسه) تتطلب اجتياز تحدي أمني قبل الدخول.
